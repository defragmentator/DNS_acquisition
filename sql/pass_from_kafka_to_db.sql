-- prod_test.pass_from_kafka_to_db source

CREATE MATERIALIZED VIEW prod_test.pass_from_kafka_to_db TO prod_test.types_z_asn
(
    ...
    `Response_Additional_records.dns_a_as_country_code` Array(Nullable(String)),

    `Response_Additional_records.dns_a_as_description` Array(Nullable(String)),

    `Response_Additional_records.dns_a_as_number` Array(Nullable(UInt32)),

    `Response_Additional_records.dns_a_country` Array(Nullable(String)),

    `Response_Additional_records.dns_a_latitude` Array(Nullable(Float32)),

    `Response_Additional_records.dns_a_longitude` Array(Nullable(Float32)),

    `Response_Additional_records.dns_a_timezone` Array(Nullable(String)),

    `Response_Additional_records.dns_a_baracuda_response_code` Array(Nullable(UInt8)),

    `Response_Additional_records.dns_a_spamhaus_response_code` Array(Nullable(UInt8)),

    `Response_Additional_records.dns_a_sorbs_response_code` Array(Nullable(UInt8)),
    ...
    `Response_Answers.dns_a_as_country_code` Array(Nullable(String)),

    `Response_Answers.dns_a_as_description` Array(Nullable(String)),

    `Response_Answers.dns_a_as_number` Array(Nullable(UInt32)),

    `Response_Answers.dns_a_country` Array(Nullable(String)),

    `Response_Answers.dns_a_latitude` Array(Nullable(Float32)),

    `Response_Answers.dns_a_longitude` Array(Nullable(Float32)),

    `Response_Answers.dns_a_timezone` Array(Nullable(String)),

    `Response_Answers.dns_a_baracuda_response_code` Array(Nullable(UInt8)),

    `Response_Answers.dns_a_spamhaus_response_code` Array(Nullable(UInt8)),

    `Response_Answers.dns_a_sorbs_response_code` Array(Nullable(UInt8)),
...
SELECT *
FROM prod_test.kafka_types_z_asn;
