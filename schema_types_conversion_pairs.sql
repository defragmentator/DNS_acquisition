...
(
   ...
   Additional_records Nested (
      ...
      dns_srv_port Nullable(String),
      dns_srv_priority Nullable(String),
      dns_srv_proto Nullable(String),
      dns_srv_service Nullable(String),
      dns_srv_target Nullable(String),
      dns_srv_weight Nullable(String),
      ...
      dns_tlsa_certificate_association_data Nullable(String),
      dns_tlsa_certificate_usage Nullable(String),
      dns_tlsa_matching_type Nullable(String),
      dns_dname Nullable(String),
      dns_tlsa_selector Nullable(String)      
   ),
   ...
   Answers Nested (
      ...
      dns_srv_target Nullable(String),
      dns_srv_weight Nullable(String),
      dns_data Nullable(String),
      dns_naptr_flags_length Nullable(String),
      dns_naptr_order Nullable(String),
      dns_naptr_preference Nullable(String),
      dns_naptr_regex Nullable(String),
      dns_naptr_regex_length Nullable(String),
      dns_naptr_replacement Nullable(String),
      dns_naptr_service Nullable(String),
      dns_naptr_service_length Nullable(String),
      dns_naptr_replacement_length Nullable(String),
      dns_spf Nullable(String),
      dns_spf_length Nullable(String),
      dns_dname Nullable(String),
      dns_resp_edns0_version Nullable(String),
      dns_resp_ext_rcode Nullable(String),
      dns_resp_z Nullable(String),
...
(
   ...
   Query_dns_id UInt16,
   Query_dns_flags Nullable(String),
   ...
   Query_udp_checksum Nullable(String),
   ...
   Query_ip_dsfield Nullable(String),
   Query_ip_len Nullable(String),
   Query_ip_id Nullable(String),
   Query_ip_flags Nullable(String),
   Query_ip_ttl Nullable(String),
   Query_ip_proto Nullable(String),
   Query_ip_checksum Nullable(String),
   ...
   Query_Authoritative_nameservers Nested (
      dns_resp_name Nullable(String),
      dns_resp_type Nullable(String),
      dns_resp_class Nullable(String),
      dns_resp_ttl Nullable(String),
   ...
   Response_frame_time_epoch String,
   ...
   Response_dns_flags Nullable(String),
...
select
   ...
   reinterpretAsInt16(reverse(unhex(queryx.dns_id))) as Query_dns_id,
   queryx.dns_flags as Query_dns_flags,
   ...
   queryx.udp_checksum as Query_udp_checksum,
   ...
   queryx.ip_dsfield as Query_ip_dsfield,
   queryx.ip_len as Query_ip_len,
   queryx.ip_id as Query_ip_id,
   queryx.ip_flags as Query_ip_flags,
   queryx.ip_ttl as Query_ip_ttl,
   queryx.ip_proto as Query_ip_proto,
   queryx.ip_checksum as Query_ip_checksum,
   ...
   queryx.Authoritative_nameservers.dns_resp_name as "Query_Authoritative_nameservers.dns_resp_name",
   queryx.Authoritative_nameservers.dns_resp_type as "Query_Authoritative_nameservers.dns_resp_type",
   queryx.Authoritative_nameservers.dns_resp_class as "Query_Authoritative_nameservers.dns_resp_class",
   queryx.Authoritative_nameservers.dns_resp_ttl as "Query_Authoritative_nameservers.dns_resp_ttl",
   queryx.Authoritative_nameservers.dns_resp_len as "Query_Authoritative_nameservers.dns_resp_len",
   queryx.Authoritative_nameservers.dns_ns as "Query_Authoritative_nameservers.dns_ns",
   queryx.Authoritative_nameservers.dns_soa_expire_limit as "Query_Authoritative_nameservers.dns_soa_expire_limit",
   queryx.Authoritative_nameservers.dns_soa_mininum_ttl as "Query_Authoritative_nameservers.dns_soa_mininum_ttl",
   queryx.Authoritative_nameservers.dns_soa_mname as "Query_Authoritative_nameservers.dns_soa_mname",
   queryx.Authoritative_nameservers.dns_soa_refresh_interval as "Query_Authoritative_nameservers.dns_soa_refresh_interval",
   queryx.Authoritative_nameservers.dns_soa_retry_interval as "Query_Authoritative_nameservers.dns_soa_retry_interval",
   queryx.Authoritative_nameservers.dns_soa_rname as "Query_Authoritative_nameservers.dns_soa_rname",
   queryx.Authoritative_nameservers.dns_soa_serial_number as "Query_Authoritative_nameservers.dns_soa_serial_number",
   queryx.Authoritative_nameservers.dns_nsec_next_domain_name as "Query_Authoritative_nameservers.dns_nsec_next_domain_name",
   queryx.Authoritative_nameservers.dns_rrsig_algorithm as "Query_Authoritative_nameservers.dns_rrsig_algorithm",
   queryx.Authoritative_nameservers.dns_rrsig_key_tag as "Query_Authoritative_nameservers.dns_rrsig_key_tag",
   queryx.Authoritative_nameservers.dns_rrsig_labels as "Query_Authoritative_nameservers.dns_rrsig_labels",
   queryx.Authoritative_nameservers.dns_rrsig_original_ttl as "Query_Authoritative_nameservers.dns_rrsig_original_ttl",
   queryx.Authoritative_nameservers.dns_rrsig_signature as "Query_Authoritative_nameservers.dns_rrsig_signature",
   queryx.Authoritative_nameservers.dns_rrsig_signature_expiration as "Query_Authoritative_nameservers.dns_rrsig_signature_expiration",
   queryx.Authoritative_nameservers.dns_rrsig_signature_inception as "Query_Authoritative_nameservers.dns_rrsig_signature_inception",
   queryx.Authoritative_nameservers.dns_rrsig_signers_name as "Query_Authoritative_nameservers.dns_rrsig_signers_name",
   queryx.Authoritative_nameservers.dns_rrsig_type_covered as "Query_Authoritative_nameservers.dns_rrsig_type_covered",
   queryx.Authoritative_nameservers.dns_ds_algorithm as "Query_Authoritative_nameservers.dns_ds_algorithm",
   queryx.Authoritative_nameservers.dns_ds_digest as "Query_Authoritative_nameservers.dns_ds_digest",
   queryx.Authoritative_nameservers.dns_ds_digest_type as "Query_Authoritative_nameservers.dns_ds_digest_type",
   queryx.Authoritative_nameservers.dns_ds_key_id as "Query_Authoritative_nameservers.dns_ds_key_id",
   -- dns_nsec3.flags_tree

   queryx.Authoritative_nameservers.dns_nsec3_algo as "Query_Authoritative_nameservers.dns_nsec3_algo",
   queryx.Authoritative_nameservers.dns_nsec3_flags as "Query_Authoritative_nameservers.dns_nsec3_flags",
   queryx.Authoritative_nameservers.dns_nsec3_iterations as "Query_Authoritative_nameservers.dns_nsec3_iterations",
   queryx.Authoritative_nameservers.dns_nsec3_salt_length as "Query_Authoritative_nameservers.dns_nsec3_salt_length",
   queryx.Authoritative_nameservers.dns_nsec3_salt_value as "Query_Authoritative_nameservers.dns_nsec3_salt_value",
   queryx.Authoritative_nameservers.dns_nsec3_hash_length as "Query_Authoritative_nameservers.dns_nsec3_hash_length",
   queryx.Authoritative_nameservers.dns_nsec3_hash_value as "Query_Authoritative_nameservers.dns_nsec3_hash_value",
   queryx.Authoritative_nameservers.dns_srv_name as "Query_Authoritative_nameservers.dns_srv_name",
   ...
   queryx.Answers.dns_resp_name as "Query_Answers.dns_resp_name",
   queryx.Answers.dns_resp_type as "Query_Answers.dns_resp_type",
   queryx.Answers.dns_resp_class as "Query_Answers.dns_resp_class",
   queryx.Answers.dns_resp_ttl as "Query_Answers.dns_resp_ttl",
   queryx.Answers.dns_resp_len as "Query_Answers.dns_resp_len",
   queryx.Answers.dns_a as "Query_Answers.dns_a",
   queryx.Answers.dns_aaaa as "Query_Answers.dns_aaaa",
   queryx.Answers.dns_cname as "Query_Answers.dns_cname",
   queryx.Answers.dns_ptr_domain_name as "Query_Answers.dns_ptr_domain_name",
   queryx.Answers.dns_rrsig_algorithm as "Query_Answers.dns_rrsig_algorithm",
   queryx.Answers.dns_rrsig_key_tag as "Query_Answers.dns_rrsig_key_tag",
   queryx.Answers.dns_rrsig_labels as "Query_Answers.dns_rrsig_labels",
   queryx.Answers.dns_rrsig_original_ttl as "Query_Answers.dns_rrsig_original_ttl",
   queryx.Answers.dns_rrsig_signature as "Query_Answers.dns_rrsig_signature",
   queryx.Answers.dns_rrsig_signature_expiration as "Query_Answers.dns_rrsig_signature_expiration",
   queryx.Answers.dns_rrsig_signature_inception as "Query_Answers.dns_rrsig_signature_inception",
   queryx.Answers.dns_rrsig_signers_name as "Query_Answers.dns_rrsig_signers_name",
   queryx.Answers.dns_rrsig_type_covered as "Query_Answers.dns_rrsig_type_covered",
   queryx.Answers.dns_ds_algorithm as "Query_Answers.dns_ds_algorithm",
   queryx.Answers.dns_ds_digest as "Query_Answers.dns_ds_digest",
   queryx.Answers.dns_ds_digest_type as "Query_Answers.dns_ds_digest_type",
   queryx.Answers.dns_ds_key_id as "Query_Answers.dns_ds_key_id",
   queryx.Answers.dns_txt as "Query_Answers.dns_txt",
   queryx.Answers.dns_txt_length as "Query_Answers.dns_txt_length",
   queryx.Answers.dns_mx_mail_exchange as "Query_Answers.dns_mx_mail_exchange",
   queryx.Answers.dns_mx_preference as "Query_Answers.dns_mx_preference",
   queryx.Answers.dns_dnskey_algorithm as "Query_Answers.dns_dnskey_algorithm",
   queryx.Answers.dns_dnskey_flags as "Query_Answers.dns_dnskey_flags",
   -- dns_dnskey_flags_tree
   queryx.Answers.dns_dnskey_key_id as "Query_Answers.dns_dnskey_key_id",
   queryx.Answers.dns_dnskey_protocol as "Query_Answers.dns_dnskey_protocol",
   queryx.Answers.dns_dnskey_public_key as "Query_Answers.dns_dnskey_public_key",
   queryx.Answers.dns_soa_expire_limit as "Query_Answers.dns_soa_expire_limit",
   queryx.Answers.dns_soa_mininum_ttl as "Query_Answers.dns_soa_mininum_ttl",
   queryx.Answers.dns_soa_mname as "Query_Answers.dns_soa_mname",
   queryx.Answers.dns_soa_refresh_interval as "Query_Answers.dns_soa_refresh_interval",
   queryx.Answers.dns_soa_retry_interval as "Query_Answers.dns_soa_retry_interval",
   queryx.Answers.dns_soa_rname as "Query_Answers.dns_soa_rname",
   queryx.Answers.dns_soa_serial_number as "Query_Answers.dns_soa_serial_number",
   queryx.Answers.dns_ns as "Query_Answers.dns_ns",
   	-- _ws_expert
	queryx.Answers.dns_srv_name as "Query_Answers.dns_srv_name",
	queryx.Answers.dns_srv_port as "Query_Answers.dns_srv_port",
	queryx.Answers.dns_naptr_flags as "Query_Answers.dns_naptr_flags",
	queryx.Answers.dns_srv_priority as "Query_Answers.dns_srv_priority",
	queryx.Answers.dns_srv_proto as "Query_Answers.dns_srv_proto",
	queryx.Answers.dns_srv_service as "Query_Answers.dns_srv_service",
	queryx.Answers.dns_srv_target as "Query_Answers.dns_srv_target",
	queryx.Answers.dns_srv_weight as "Query_Answers.dns_srv_weight",
	queryx.Answers.dns_data as "Query_Answers.dns_data",
	queryx.Answers.dns_naptr_flags_length as "Query_Answers.dns_naptr_flags_length",
	queryx.Answers.dns_naptr_order as "Query_Answers.dns_naptr_order",
	queryx.Answers.dns_naptr_preference as "Query_Answers.dns_naptr_preference",
	queryx.Answers.dns_naptr_regex as "Query_Answers.dns_naptr_regex",
	queryx.Answers.dns_naptr_regex_length as "Query_Answers.dns_naptr_regex_length",
	queryx.Answers.dns_naptr_replacement as "Query_Answers.dns_naptr_replacement",
	queryx.Answers.dns_naptr_service as "Query_Answers.dns_naptr_service",
	queryx.Answers.dns_naptr_service_length as "Query_Answers.dns_naptr_service_length",
	queryx.Answers.dns_naptr_replacement_length as "Query_Answers.dns_naptr_replacement_length",
   queryx.Answers.dns_spf as "Query_Answers.dns_spf",
   queryx.Answers.dns_spf_length as "Query_Answers.dns_spf_length",
   queryx.Answers.dns_dname as "Query_Answers.dns_dname",
   queryx.Answers.dns_resp_edns0_version as "Query_Answers.dns_resp_edns0_version",
   queryx.Answers.dns_resp_ext_rcode as "Query_Answers.dns_resp_ext_rcode",
   queryx.Answers.dns_resp_z as "Query_Answers.dns_resp_z",
         -- dns_resp_z_tree
   queryx.Answers.dns_rr_udp_payload_size as "Query_Answers.dns_rr_udp_payload_size",
   ...
   reinterpretAsInt16(reverse(unhex(response.dns_id))) as Response_dns_id,
   response.dns_flags as Response_dns_flags,
   ...
   response.udp_checksum as Response_udp_checksum,
   ...
   response.ip_dsfield as Response_ip_dsfield,
   response.ip_len as Response_ip_len,
   response.ip_id as Response_ip_id,
   response.ip_flags as Response_ip_flags,
   response.ip_ttl as Response_ip_ttl,
   response.ip_proto as Response_ip_proto,
   response.ip_checksum as Response_ip_checksum,
...
from test.dump_null as queryx left outer join test.dump_null as response on queryx.frame_number=response.dns_response_to
where queryx.dns_response_to is null
